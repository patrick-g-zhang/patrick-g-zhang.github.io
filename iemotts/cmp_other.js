...
$(document).ready(function () {
   ...
   var system_list = [
      "mix2_gvq_spkadv_105_pspk", "mix2_bdcln2", "mix2_pan4"
   ];

  
   // var $clone = $t_url.clone();

var tbody = $("#cmp_other_table tbody");
var t_row1 = $("#cmp_other_table_row1");
var t_row2= $("#cmp_other_table_row2");
...
$.each(disen_list, function(index, data) {
   ...
   {
      new_audio_path = "cmp_other/" + data.emo_name + "/" + system_list[index] + "/"  + data.wav_fn_1 + '_TGLF'+ ".wav";
